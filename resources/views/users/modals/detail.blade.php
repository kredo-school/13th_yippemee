    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="plan-header">
                <button type="button" class="close-detail border-0" style="background-color:#617ea8;" data-bs-toggle="modal" data-bs-target="#planList-modal"><i class="fa-solid fa-arrow-left fa-2x" style="color: white"></i></button>
                <h4 class="modal-title" id="detailModalLabel">User 1 <i class="fa-regular fa-user-circle me-2"></i></h4>
            ...
            <div class="container modal-body" id="detail-body">
                ...
                <div class="container" id="preference-detail">
                    ...
                    <div class="preference ms-5">
                        <div class="row">
                            <h5><span>Preferences</span></h5>
                        </div>
                        <div class="row" style="height:22px; display:flex; align-items:center;">
