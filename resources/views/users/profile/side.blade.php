...
<div class="bg-white container ms-auto me-auto rounded-3 p-5w">
    <div class="row">
        <div class="col-3 mt-3">
            {{-- Intro --}}
            <nav id="sidebarMenu" class="sidebarMenu collapse d-lg-block sidebar collapse bg-white shadow">
                ...
                <div class="title-line"><i class="fa-regular fa-face-meh me-3"></i><span class="fw-bold">Intro</span></div>
                    ...
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple mb-3"><i
                        class="fa-solid fa-burger me-3 link-place" data-bs-toggle="modal" data-bs-target="#edit-intro"></i><span>Favorite Genre</span>
                    </a>
                </div>
                ...
                <div class="mx-3 mt-4 sidebar-profile">
                    ...
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple"><i class="fa-regular fa-pen-to-square me-3 link-place"></i><span>Post</span>
                    </a>
                    ...
                    <a href="{{ route('bucket.create') }}" class="list-group-item list-group-item-action py-2 ripple"><i
                            class="fa-solid fa-bucket me-3 link-place"></i><span>Bucket List</span>
                        </a>
                </div>
            </nav>
        </div>
