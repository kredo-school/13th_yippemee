        ...
        <div class="col-3 mt-3">
            ...
            <nav id="sidebarMenu" class="sidebarMenu collapse d-lg-block sidebar collapse bg-white shadow ps-3 pt-2" style="padding-bottom: 20px">
                <div class="mx-3 sidebar-profile">
                    ...
                    <a href="{{ route('profile.edit') }}" class="list-group-item list-group-item-action py-2 ripple mb-3"><i class="fa-solid fa-burger me-3 link-place" data-bs-toggle="modal" data-bs-target="#edit-intro"></i><span>#</span>
                    </a>
                </div>
