<div class="modal fade" id="publiccreateplan-modal" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content ">
            <div class="modal-header w-100 align-items-center" style="color: #F1A29B; background-color: #F1A29B;">
                        <div class="row w-100" >
                            <div class="col-11">
