                ...
                <div class="row ">
                        <div class="detail-left col-md-6 bg-white">
                            ...
                            <h4 class="mt-1">
                                ...
                                <ul class="ms-5">
                                    <li><i class="fa-solid fa-utensils"></i> Restaurant name</li>
                                    <li><i class="fa-solid fa-calendar-days"></i>13/9/2023</li>
                                    <li><i class="fa-solid fa-clock"></i>12:00 - 14:00</li>
                                </ul>
                            <h4 class="mt-4"><u><i class="fa-solid fa-user me-1"></i>Member list</u></h4>
                                <ul class="ms-5">
                                    <li>User name</li>
                                    <li>User name</li>
                                    <li>User name</li>
                                </ul>
                            <h4 class="mt-4 mb-4"><u><i class="fa-solid fa-file me-1"></i>Description</u></h4>
